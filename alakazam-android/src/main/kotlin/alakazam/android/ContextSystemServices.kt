...
public val Context.appOpsManager: AppOpsManager
  get() = requireSystemService()
public val Context.appSearchManager: AppSearchManager
  get() = requireSystemService()
...
public val Context.batteryManager: BatteryManager
  get() = requireSystemService()
public val Context.biometricManager: BiometricManager
  get() = requireSystemService()
public val Context.blobStoreManager: BlobStoreManager
  get() = requireSystemService()
public val Context.bluetoothManager: BluetoothManager
  get() = requireSystemService()
public val Context.cameraManager: CameraManager
  get() = requireSystemService()
public val Context.captioningManager: CaptioningManager
  get() = requireSystemService()
public val Context.carrierConfigManager: CarrierConfigManager
  get() = requireSystemService()
public val Context.clipboardManager: ClipboardManager
  get() = requireSystemService()
public val Context.companionDeviceManager: CompanionDeviceManager
  get() = requireSystemService()
public val Context.connectivityDiagnosticsManager: ConnectivityDiagnosticsManager
  get() = requireSystemService()
public val Context.connectivityManager: ConnectivityManager
  get() = requireSystemService()
public val Context.consumerIrManager: ConsumerIrManager
  get() = requireSystemService()
public val Context.crossProfileApps: CrossProfileApps
  get() = requireSystemService()
public val Context.devicePolicyManager: DevicePolicyManager
  get() = requireSystemService()
public val Context.displayHashManager: DisplayHashManager
  get() = requireSystemService()
public val Context.displayManager: DisplayManager
  get() = requireSystemService()
public val Context.domainVerificationManager: DomainVerificationManager
  get() = requireSystemService()
public val Context.downloadManager: DownloadManager
  get() = requireSystemService()
public val Context.dropBoxManager: DropBoxManager
  get() = requireSystemService()
public val Context.euiccManager: EuiccManager
  get() = requireSystemService()
public val Context.fileIntegrityManager: FileIntegrityManager
  get() = requireSystemService()
public val Context.gameManager: GameManager
  get() = requireSystemService()
public val Context.hardwarePropertiesManager: HardwarePropertiesManager
  get() = requireSystemService()
public val Context.imsManager: ImsManager
  get() = requireSystemService()
public val Context.inflater: LayoutInflater
  get() = requireSystemService()
public val Context.inputManager: InputManager
  get() = requireSystemService()
public val Context.inputMethodManager: InputMethodManager
  get() = requireSystemService()
public val Context.ipSecManager: IpSecManager
  get() = requireSystemService()
...
public val Context.mediaRouter: MediaRouter
  get() = requireSystemService()
public val Context.mediaSessionManager: MediaSessionManager
  get() = requireSystemService()
public val Context.midiManager: MidiManager
  get() = requireSystemService()
public val Context.networkStatsManager: NetworkStatsManager
  get() = requireSystemService()
...
public val Context.nsdManager: NsdManager
  get() = requireSystemService()
public val Context.peopleManager: PeopleManager
  get() = requireSystemService()
public val Context.performanceHintManager: PerformanceHintManager
  get() = requireSystemService()
...
public val Context.restrictionsManager: RestrictionsManager
  get() = requireSystemService()
public val Context.roleManager: RoleManager
  get() = requireSystemService()
public val Context.searchManager: SearchManager
  get() = requireSystemService()
public val Context.sensorManager: SensorManager
  get() = requireSystemService()
public val Context.shortcutManager: ShortcutManager
  get() = requireSystemService()
public val Context.statusBarManager: StatusBarManager
  get() = requireSystemService()
public val Context.storageManager: StorageManager
  get() = requireSystemService()
public val Context.storageStatsManager: StorageStatsManager
  get() = requireSystemService()
public val Context.subscriptionManager: SubscriptionManager
  get() = requireSystemService()
public val Context.systemHealthManager: SystemHealthManager
  get() = requireSystemService()
public val Context.telecomManager: TelecomManager
  get() = requireSystemService()
public val Context.telephonyManager: TelephonyManager
  get() = requireSystemService()
public val Context.textClassificationManager: TextClassificationManager
  get() = requireSystemService()
public val Context.textServicesManager: TextServicesManager
  get() = requireSystemService()
public val Context.tvInputManager: TvInputManager
  get() = requireSystemService()
public val Context.tvInteractiveAppManager: TvInteractiveAppManager
  get() = requireSystemService()
public val Context.uiModeManager: UiModeManager
  get() = requireSystemService()
public val Context.usageStatsManager: UsageStatsManager
  get() = requireSystemService()
...
public val Context.vibrator: Vibrator
  get() = requireSystemService()
public val Context.vibratorManager: VibratorManager
  get() = requireSystemService()
public val Context.vpnManager: VpnManager
  get() = requireSystemService()
public val Context.wallpaperService: WallpaperService
  get() = requireSystemService()
public val Context.wifiAwareManager: WifiAwareManager
  get() = requireSystemService()
public val Context.wifiManager: WifiManager
  get() = requireSystemService()
public val Context.wifiP2pManager: WifiP2pManager
  get() = requireSystemService()
public val Context.windowManager: WindowManager
  get() = requireSystemService()
