...
include(":modules:tak:compose:components")
include(":modules:tak:compose:core")
include(":modules:tak:compose:icons")
include(":modules:tak:compose:plugin")
include(":modules:tak:compose:preview")
include(":modules:tak:compose:viewmodel")
