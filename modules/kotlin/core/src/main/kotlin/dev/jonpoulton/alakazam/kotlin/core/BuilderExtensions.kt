 ...
 */
public fun <B> B.ifTrue(condition: Boolean, action: B.() -> B): B {
 ...
 */
public fun <B> B.ifFalse(condition: Boolean, action: B.() -> B): B {
  return if (!condition) this.action() else this
}
 ...
 */
public fun <B, Value> B.ifNotNull(value: Value?, action: B.(Value) -> B): B {
 ...
 */
public fun <B, Value> B.ifNull(value: Value?, action: B.() -> B): B {
  return if (value == null) this.action() else this
}

public fun <B, T> B.ifEquals(value1: T?, value2: T?, action: B.() -> B): B {
  return ifTrue(condition = value1 == value2, action)
}

public fun <B, T> B.ifNotEquals(value1: T?, value2: T?, action: B.() -> B): B {
  return ifTrue(condition = value1 != value2, action)
}
