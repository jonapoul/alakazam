package dev.jonpoulton.alakazam.json
...
inline fun <reified E> enumStringSerializer(
  ignoreCase: Boolean = false,
): KSerializer<E> where E : Enum<E>, E : SerializableByString {
  return object : KSerializer<E> {
    override val descriptor = PrimitiveSerialDescriptor(serialName = "Enum", kind = PrimitiveKind.STRING)
...
interface SerializableByString {
  val value: String
}
