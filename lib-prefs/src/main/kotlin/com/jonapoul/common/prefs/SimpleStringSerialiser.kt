...
abstract class SimpleNullableStringSerialiser<T : Any>(private val constructor: (String) -> T) : NullableSerializer<T> {
...
abstract class SimpleStringSerialiser<T : Any>(private val constructor: (String) -> T) : Serializer<T> {
